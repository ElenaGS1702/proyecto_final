export default function SeatGrid({
  ...
  const isOcc = (r, c) =>
    occupied.some((s) => Number(s.row) === r && Number(s.col) === c);
        ...
        <button
          ...
          className={[
            ...
            occ
              ...
              : "bg-white dark:bg-green-600 border-slate-300 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-800",
          ].join(" ")}
